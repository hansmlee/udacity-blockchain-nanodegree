...
it('can add the star name and star symbol properly', async() => {
    ...
    //let StarSymbol = await instance.symbole();
    //let StarLookUp = await instance.lookUptokenIdToStarInfo(starId);
    assert.equal(await instance.name(),"Amazing North Star");
    assert.equal(await instance.symbol(),"ANS");
...
it('lets 2 users exchange stars', async() => {
    ...
    let TokenId1 = 12;
    let TokenId2 = 13;
    await instance.createStar("Star One", TokenId1, {from:user1});
    await instance.createStar("Star Two", TokenId2, {from:user2});
    ...
    // 3. Verify that tinstancehe owners changed
